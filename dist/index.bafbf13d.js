...
})({"dhBiH":[function(require,module,exports) {
"use strict";
var HMR_HOST = null;
var HMR_PORT = null;
...
var _weatherAppViewJs = require("./view/weatherAppView.js");
var _weatherAppViewJsDefault = parcelHelpers.interopDefault(_weatherAppViewJs);
const renderController = function() {
    setTimeout(function() {
        _weatherAppViewJsDefault.default.render(_modelJs.state.weatherData);
    }, 1000);
};
const controlLiveRender = async function() {
    if (navigator.geolocation) navigator.geolocation.getCurrentPosition(_modelJs.loadWeather);
    renderController();
};
const controlFindWeather = function(inputValue) {
    _modelJs.findGeoLocation(inputValue);
    renderController();
};
const init = function() {
    _weatherAppViewJsDefault.default.addHandlerLive(controlLiveRender);
    _weatherAppViewJsDefault.default.addHandlerFind(controlFindWeather);
};
init();

},{"./model.js":"dEDha","./view/weatherAppView.js":"61rfp","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"dEDha":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "state", ()=>state
);
parcelHelpers.export(exports, "createWeatherObject", ()=>createWeatherObject
);
parcelHelpers.export(exports, "loadWeather", ()=>loadWeather
);
parcelHelpers.export(exports, "findGeoLocation", ()=>findGeoLocation
);
...
const loadWeather = async function(pos) {
    const { latitude , longitude  } = pos.coords;
    try {
        const res = await fetch(`${_configJs.API_URL}lat=${latitude}&lon=${longitude}&appid=${_configJs.API_KEY}`);
...
const findGeoLocation = async function(place) {
    try {
        const res = await fetch(`${_configJs.GEOCODE_API_URL}${place[0]},${place[1]},${place[2]}&limit=3&appid=${_configJs.API_KEY}`);
        const data = await res.json();
        if (!res.ok) throw new Error(`${data} (${res.status})`);
...
},{"./config.js":"jtCLN","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"jtCLN":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
parcelHelpers.export(exports, "GEOCODE_API_URL", ()=>GEOCODE_API_URL
);
const API_KEY = 'b3d7eddfce8ba372d1a0786f299a79a7';
const API_URL = 'https://api.openweathermap.org/data/2.5/weather?';
const GEOCODE_API_URL = 'http://api.openweathermap.org/geo/1.0/direct?q='; // {city name},{state code},{country code}&limit={limit}&appid={API key}
...
},{}],"61rfp":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
        ...
        <div class="contend">
            <div class="weather__temp">
                ...
                <div class="temp__temp">
                    <p class="temp-temp main">${_helperJs.tempFormat(this._data.temp)}°</p>
                    <p class="temp-climate sub">Feels like ${_helperJs.tempFormat(this._data.feelsLike)}°C</p>
                </div>
            </div> 
            ...
            <div class="weather__others">
                ...
                <ul class="others_1">
                    <li class="main first">${_helperJs.tempFormat(this._data.tempMax)}°</li>
                    <li class="sub">High</li>
                    <li class="main second">${_helperJs.tempFormat(this._data.tempMin)}°</li>
                    <li class="sub">low</li>
                </ul>
                <ul class="others_2">
                ...
                <ul class="others_3">
                    <li class="main first">${_helperJs.timeFormat(this._data.sunrise)}</li>
                    <li class="sub">Sunrise</li>
                    <li class="main second">${_helperJs.timeFormat(this._data.sunset)}</li>
...
exports.default = new WeatherAppView();

},{"../helper.js":"3r8hW","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"3r8hW":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "tempFormat", ()=>tempFormat
);
...
const timeFormat = function(suntime) {
    const options = {
        hour12: false,
        hour: '2-digit',
        minute: '2-digit'
